...
const Navbar = () => {
    const svgProfile = <div>
        <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
            <path clip-rule="evenodd"
                  ...
                  fill="#447BBA" fill-rule="evenodd"></path>
        </svg>
    </div>
    const svgDialogs = <div><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <g id="message_outline_20__Page-2" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="message_outline_20__message_outline_20" fill="none">
                    <path id="message_outline_20__Shape" opacity=".4" d="M0 0h20v20H0z" fill="none"></path>
                    <path
                        ...
                        id="message_outline_20__Icon-Color" fill="#447BBA" fill-rule="nonzero"></path>
                </g>
            </g>
        </svg>
    </div>
    const svgUsers = <div><svg xmlns="http://www.w3.org/1999/xlink" fill="#447BBA" height="20" viewBox="0 0 20 20" width="20"><g fill="#447BBA"><g clip-rule="#447BBA" fill-rule="evenodd" fill="#447BBA"><path d="M6.25 3.5a3 3 0 1 0 0 6 3 3 0 0 0 0-6zm-1.5 3a1.5 1.5 0 1 0 3 0 1.5 1.5 0 0 0-3 0zm-2.06 5.07c.96-.55 2.22-.82 3.56-.82s2.6.27 3.56.82c.98.56 1.69 1.47 1.69 2.68 0 .7-.28 1.3-.78 1.71-.48.39-1.1.54-1.72.54H3.5c-.61 0-1.24-.15-1.72-.54-.5-.4-.78-1-.78-1.71 0-1.21.71-2.12 1.69-2.68zm.75 1.3c-.65.37-.94.84-.94 1.38 0 .3.1.44.22.54.14.11.4.21.78.21H9c.39 0 .64-.1.78-.21.12-.1.22-.25.22-.54 0-.54-.29-1-.94-1.38-.66-.39-1.65-.62-2.81-.62s-2.15.23-2.81.62zM13.75 3.5a3 3 0 1 0 0 6 3 3 0 0 0 0-6zm-1.5 3a1.5 1.5 0 1 0 3 0 1.5 1.5 0 0 0-3 0z" fill="#447BBA"></path></g><path d="M13.75 12.25c-.23 0-.45.01-.68.03a.75.75 0 1 1-.14-1.49c.27-.03.54-.04.82-.04 1.34 0 2.6.27 3.56.82.98.56 1.69 1.47 1.69 2.68 0 .7-.28 1.3-.78 1.71-.48.39-1.1.54-1.72.54h-3a.75.75 0 0 1 0-1.5h3c.39 0 .64-.1.78-.21.12-.1.22-.25.22-.54 0-.54-.29-1-.94-1.38a5.77 5.77 0 0 0-2.81-.62z" fill="#447BBA"></path></g></svg></div>
    const svgNews = <div>
        <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
            <path clip-rule="evenodd"
    ...
    const svgMusic = <div>
        <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
            ...
            <path fill="#447BBA" fill-rule="evenodd"
    ...
    const svgSettings = <div>
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd"
                  ...
                  clip-rule="evenodd" fill="#447BBA"></path>
        </svg>
    </div>
