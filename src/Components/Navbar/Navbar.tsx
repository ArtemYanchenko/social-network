        ...
        <nav className={classes.nav + ' ' + classes.active}>
            <div className={classes.navLink}>
                <NavLink to={'/profile'}>
                    ...
                    Profile</NavLink></div>
            <div className={classes.navLink}><NavLink to={'/dialogs'}>
            ...
            <div className={classes.navLink}><NavLink to={'/news'}>
                ...
                News</NavLink></div>
            <div className={classes.navLink}><NavLink to={'/music'}>
                <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
                    <path fill="#447BBA"
                ...
                Music</NavLink></div>
            <div className={classes.navLink}><NavLink to={'/settings'}>
